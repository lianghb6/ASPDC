...
lambda = 0.0001;%%0.01,0.001,0.0001，1e-5
tol = 1e-12;
n_epoch = 24;
verbose = 1;
...
%% Draw Dual_gap
figure
semilogy(0:size(dual_gap_sdca)-1, dual_gap_sdca, 'g-*');
hold on,semilogy(0:size(dual_gap_spdc)-1, dual_gap_spdc, 'm-square');
hold on,semilogy(0:size(dual_gap_spdc_r7)-1, dual_gap_spdc_r7,'k-v');
hold off
